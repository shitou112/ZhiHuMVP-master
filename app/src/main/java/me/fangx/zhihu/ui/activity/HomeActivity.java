...
public class HomeActivity extends BaseAppCompatActivity {
    ...
    public void deleteDataTable(){
        ...
        dbh.delete(sqLiteDatabase);
    }

    @OnClick({R.id.user_img, R.id.tv_setting, R.id.tv_change_theme, R.id.deleteImpliciteDataTable})
    public void viewClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_change_theme:
                ...
                break;
            case  R.id.deleteImpliciteDataTable:
                deleteDataTable();
                Toast.makeText(this, "delete all table", Toast.LENGTH_SHORT).show();
                break;
        }
    }
