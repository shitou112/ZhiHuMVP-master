...
public abstract class TouchEvent extends Generator{
    ...
    public static final String clickFeatureList[] = {
            "x", //0
            "y", //1
            "timestamp" //2
    };
    ...
    public static final int NUM_CLICK_FEATURES = clickFeatureList.length;
    ...
    protected FeatureVector computeClickFeatureVector(
            ArrayList<TouchPoint> clickPoints) {
        FeatureVector fv = new FeatureVector(NUM_CLICK_FEATURES);
